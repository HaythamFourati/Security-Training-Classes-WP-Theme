...
$description = wp_trim_words(wp_strip_all_tags($class_data['description']), 20, '...');
...
if (empty($thumbnail_url)) {
    $thumbnail_url = get_theme_file_uri('/images/default-class-image.jpg'); // Make sure you have this image
}
...
<div class="bg-white rounded-lg shadow-lg overflow-hidden flex flex-col class-item" data-category="<?php echo $category; ?>">
    ...
    <div class="p-6 flex-grow flex flex-col">
        ...
        <p class="text-steel-gray mb-4 text-sm"><?php echo $description; ?></p>
