...
<section id="contact" class="py-20 bg-gray-50 text-navy">
    <div class="container mx-auto text-center px-4">
        ...
        <p class="text-sm"><?php echo esc_html($GLOBALS['address']); ?></p>
       <p class="text-sm mb-8"><a href="tel:<?php echo preg_replace('/[^0-9]/', '', $GLOBALS['phone_number']); ?>"><strong>Phone:</strong> <?php echo esc_html($GLOBALS['phone_number']); ?></a></p>
